...
#
# Create symlinks to shared log directory
#
if [ ! -d /x/web/logs/$name/state-logs ]; then
        mkdir -p /x/web/logs/$name/state-logs
fi
if [ ! -L $prefix/$name/state-logs ]; then
        ln -s /x/web/logs/$name/state-logs $prefix/$name/state-logs
fi
