 ...
 *
 */
public class MockJunoUnresponsiveServer extends Thread {
    ...
    public MockJunoUnresponsiveServer(int sockTimeout, boolean freeze) {
        this.freeze = freeze;
    ...
    public class processRequest extends Thread{
         ...
         *
         * @param in the input stream containing the serialized the message from the client
