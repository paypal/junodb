...
public class JunoReactClientImplTest {

    private JunoClientConfigHolder clientCfgHldr;
    private JunoReactClient client;
    ...
    public void initialize() throws Exception {
        ...
        mjs.start();
        client = JunoClientFactory.newJunoReactClient(url);
    }
    ...
    public void insertTest() {
        ...
        JunoResponse resp = client.create("insertTest".getBytes(), "Antony".getBytes()).block();
        assertEquals(OperationStatus.Success,resp.getStatus());
        try{
            resp = client.create("insertTest".getBytes(), "Antony".getBytes()).block();
    ...
    public void insertTest_withTTL() {
        ...
        JunoResponse resp = client.create("insertTest".getBytes(), "Antony".getBytes(),20).block();
        assertEquals(OperationStatus.Success,resp.getStatus());
        try{
            resp = client.create("insertTest".getBytes(), "Antony".getBytes(),30).block();
            assertEquals(OperationStatus.UniqueKeyViolation,resp.getStatus());
        }catch(JunoException e){
            AssertJUnit.assertTrue ("Exception for UniqueKeyViolation", false);
        }
    ...
    public void GetTest() {
        ...
        JunoResponse resp = client.get("GetTest".getBytes()).block();
        assertEquals(OperationStatus.Success,resp.getStatus());
        try{
            resp = client.get("GetTest1".getBytes()).block();
    ...
    public void OpaqueResMapClearTest(){
        ...
        for(int i =0; i< 100; i++){
            Mono<JunoResponse> response = client.get("OpaqueResMapClearTest".getBytes());
            response.subscribe(res -> {
                assertEquals(OperationStatus.Success,res.getStatus());
                }, error -> {
                assertEquals(OperationStatus.InternalError.getErrorText(), error.getMessage());
            });
        }
        Set<Thread> threadSet = Thread.getAllStackTraces().keySet();
        for(Thread thread : threadSet){
            if(thread.getName().contains("boundedElastic")){
                thread.interrupt();
            }
        }
        ...
        try{
            Thread.sleep(3000);
            Field opaqueResMapField = client.getClass().getDeclaredField("opaqueResMap");
            opaqueResMapField.setAccessible(true);
            trial = (ConcurrentHashMap) opaqueResMapField.get(client);
    ...
    public void GetTest_withTTL() {
        ...
        JunoResponse resp = client.get("GetTest_withTTL".getBytes(),20).block();
        assertEquals(OperationStatus.Success,resp.getStatus());
        try{
            resp = client.get("GetTest_withTTL1".getBytes(),10).block();
            assertEquals(OperationStatus.NoKey,resp.getStatus());
        }catch(JunoException e){
            AssertJUnit.assertTrue ("Exception for NoKey", false);
        }
    ...
    public void UpdateTest() {
        ...
        JunoResponse resp = client.update("UpdateTest".getBytes(),"Updated".getBytes()).block();
        ...
        try{
            resp = client.update("UpdateTest1".getBytes(),"Updated".getBytes()).block();
            assertEquals(OperationStatus.NoKey,resp.getStatus());
        }catch(JunoException e){
            AssertJUnit.assertTrue ("Exception for NoKey", false);
        }
    ...
    public void CompateAndSetTest() {
        ...
        resp = client.compareAndSet(resp.getRecordContext(),"Updated".getBytes(),20).block();
        ...
        try{
            resp = client.compareAndSet(rctx,"Updated".getBytes(),20).block();
    ...
    public void UpdateTest_withTTL() {
        ...
        JunoResponse resp = client.update("UpdateTest_withTTL".getBytes(),"Updated".getBytes(),20).block();
    ...
    public void UpsertTest() {
        ...
        JunoResponse resp = client.set("UpsertTest".getBytes(),"Updated".getBytes()).block();

        assertEquals(OperationStatus.Success,resp.getStatus());
        assertEquals("Updated",(new String(resp.getValue())));
        assertEquals(2,resp.getVersion());

        resp = client.set("UpsertTest1".getBytes(),"Created".getBytes()).block();
    ...
    public void UpsertTest_withTTL() {
        ...
        JunoResponse resp = client.set("UpsertTest_withTTL".getBytes(),"Updated".getBytes()).block();

        assertEquals(OperationStatus.Success,resp.getStatus());
        assertEquals("Updated",(new String(resp.getValue())));
        assertEquals(2,resp.getVersion());

        resp = client.set("UpsertTest_withTTL1".getBytes(),"Created".getBytes()).block();
    ...
    public void DestroyTest() {
        ...
        JunoResponse resp = client.delete("DestroyTest".getBytes()).block();
        assertEquals(OperationStatus.Success,resp.getStatus());

        // try to destroy a record which is not present in DB.
        try{
            resp = client.delete("DestroyTest1".getBytes()).block();
            assertEquals(OperationStatus.Success,resp.getStatus());
        }catch(JunoException e){
    ...
    public void CreateNegativeTest() {
        try{
            client.create("".getBytes(), "InsertNegativeValue".getBytes()).block();
        ...
        try{
            client.create(longKey.getBytes(),"".getBytes()).block();
...
//			 byte[] array = new byte[804900]; // length is bounded by
            ...
            client.create("Test".getBytes(),payload.getBytes()).block();
        ...
        try{
            client.create("".getBytes(), "InsertNegativeValue".getBytes(),10).block();
            AssertJUnit.assertTrue ("Exception not seen for empty key", false);
        }catch(JunoException e){
            //System.out.println("Error is:"+e.getCause().getMessage());
            assertEquals(OperationStatus.IllegalArgument.getErrorText(),e.getMessage());
        ...
        try{
            client.create("InsertNegative".getBytes(), "InsertNegativeValue".getBytes(),0).block();
    ...
    public void GetNegativeTest(){
        ...
        try{
            client.get(longKey.getBytes()).block();
            AssertJUnit.assertTrue ("Exception not seen for long key", false);
        }catch(JunoException e){
            assertTrue(e.getCause() instanceof IllegalArgumentException);
            assertEquals(OperationStatus.IllegalArgument.getErrorText(),e.getMessage());
        ...
        try{
            client.get("getNegative".getBytes(),900000000).block();
        }catch(JunoException e){
            //System.out.println("get Error is:"+e.getCause().getMessage());
            assertEquals(OperationStatus.IllegalArgument.getErrorText(),e.getMessage());
            assertTrue(e.getCause() instanceof IllegalArgumentException);
    ...
    public void UpdateNegativeTest() {
        try{
            client.update("UpdateNegative".getBytes(), "UpdateNegativeValue".getBytes(),-1).block();
        ...
        try{
            client.update("".getBytes(), "UpdateNegativeValue".getBytes()).block();
            AssertJUnit.assertTrue ("Exception not seen for empty key", false);
        }catch(JunoException e){
        ...
        try{
            client.update(longKey.getBytes(),"".getBytes()).block();
            AssertJUnit.assertTrue ("Exception not seen for long key", false);
        }catch(JunoException e){
            assertTrue(e.getCause() instanceof IllegalArgumentException);
            assertEquals(OperationStatus.IllegalArgument.getErrorText(),e.getMessage());
        ...
        try{
            client.update("UpdateNegative".getBytes(), new String(new char[204900]).replace('\0', 'a').getBytes()).block();
        }catch(JunoException e){
        ...
        try{
            client.update("".getBytes(), "UpdateNegativeValue".getBytes(),10).block();
            AssertJUnit.assertTrue ("Exception not seen for empty key", false);
        }catch(JunoException e){
        ...
        try{
            client.update("UpdateNegative".getBytes(), new String(new char[204900]).replace('\0', 'a').getBytes(),0).block();
        }catch(JunoException e) {
    ...
    public void SetNegativeTest() {
        try{
            JunoResponse res = client.set("SetNegative".getBytes(), "".getBytes()).block();
            assertEquals(OperationStatus.Success,res.getStatus());
        }catch(JunoException e){
        ...
        try{
            client.set("".getBytes(), "".getBytes()).block();
            AssertJUnit.assertTrue ("Exception not seen for empty key", false);
        }catch(JunoException e){
            assertEquals(OperationStatus.IllegalArgument.getErrorText(),e.getMessage());
            assertTrue(e.getCause() instanceof IllegalArgumentException);
        ...
        try{
            client.set(longKey.getBytes(),"".getBytes()).block();
            AssertJUnit.assertTrue ("Exception not seen for long key", false);
        }catch(JunoException e){
            assertTrue(e.getCause() instanceof IllegalArgumentException);
            assertEquals(OperationStatus.IllegalArgument.getErrorText(),e.getMessage());
        ...
        try{
            JunoResponse res = client.set("".getBytes(), "".getBytes(),10).block();
            assertEquals(OperationStatus.Success,res.getStatus());
        }catch(JunoException e){
            assertEquals(OperationStatus.IllegalArgument.getErrorText(),e.getMessage());
            assertTrue(e.getCause() instanceof IllegalArgumentException);
        ...
        try{
            client.set(longKey.getBytes(),"".getBytes(),10).block();
            AssertJUnit.assertTrue ("Exception not seen for long key", false);
        }catch(JunoException e){
            assertTrue(e.getCause() instanceof IllegalArgumentException);
            assertEquals(OperationStatus.IllegalArgument.getErrorText(),e.getMessage());
        ...
        try{
            client.set("SetNegative".getBytes(), "SetNegativeValue".getBytes(),-1).block();
        }catch(JunoException e) {
            assertEquals(OperationStatus.IllegalArgument.getErrorText(), e.getMessage());
            assertTrue(e.getCause() instanceof IllegalArgumentException);
            assertEquals(e.getCause().getMessage(), "The Document's TTL cannot be negative. Current lifetime=-1");
    ...
    public void CompareAndSetNegativeTest() {
        try{
            ...
            JunoResponse res = client.compareAndSet(rctx, "CompareAndSetKeyNotInDb".getBytes(),1200).block();
        ...
        try{
            ...
            client.compareAndSet(rctx, "CompareAndSetKeyNotInDb".getBytes(),1200).block();
            AssertJUnit.assertTrue ("Exception not seen for Long key", false);
        }catch(JunoException e){
            assertTrue(e.getCause() instanceof IllegalArgumentException);
            assertEquals(OperationStatus.IllegalArgument.getErrorText(),e.getMessage());
        ...
        try{
            client.compareAndSet(null, "CompareAndSetKeyNotInDb".getBytes(),1200).block();
        ...
        try{
            RecordContext rctx = new RecordContext("Test".getBytes(),1,100,100);
            client.compareAndSet(rctx, "CompareAndSetNegativeValue".getBytes(),-1).block();
        }catch(JunoException e){
            assertEquals(OperationStatus.IllegalArgument.getErrorText(),e.getMessage());
            assertTrue(e.getCause() instanceof IllegalArgumentException);
            assertEquals(e.getCause().getMessage(),"The Document's TTL cannot be negative. Current lifetime=-1");
    ...
    public void DestroyNegativeTest() {
        try{
            client.delete("DeleteNegative".getBytes()).block();
        }catch(JunoException e){
            AssertJUnit.assertTrue ("Exception for deletion for nokey in db", false);
        }

        try{
            client.delete("".getBytes()).block();
            AssertJUnit.assertTrue ("Exception not seen for empty key", false);
        }catch(JunoException e){
            assertEquals(OperationStatus.IllegalArgument.getErrorText(),e.getMessage());
            assertTrue(e.getCause() instanceof IllegalArgumentException);
        ...
        try{
            client.delete(longKey.getBytes()).block();
        }catch(JunoException e){
            assertTrue(e.getCause() instanceof IllegalArgumentException);
            assertEquals(OperationStatus.IllegalArgument.getErrorText(),e.getMessage());
            assertEquals(e.getCause().getMessage(),"The Document key must not be larger than 128 bytes");
    ...
    public void doBatchNegativeTest(){
        ...
        try{
            ...
            list.add(item);
            Iterable<JunoResponse> batchResp = client.doBatch(list).toIterable();
        ...
        try{
            ...
            client.doBatch(list).toIterable();
            //AssertJUnit.assertTrue ("Exception not seen for empty request list", false);
        }catch(JunoException e){
