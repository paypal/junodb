...
public class ConditionalUpdateTest{
	...
	public void testCUpdateWithDiffPayload() throws JunoException, IOException{
		...
		JunoResponse junoResponse1 = junoClient.compareAndSet(junoResponse.getRecordContext(), data1, (long)5);
	...
	public void testCUpdateWithSamePayload() throws JunoException, IOException {
		...
		JunoResponse junoResponse1 = junoClient.compareAndSet(junoResponse.getRecordContext(), data, (long)5);
		AssertJUnit.assertEquals (OperationStatus.Success,junoResponse1.getStatus());
		junoResponse1 = junoClient.get(key);
		AssertJUnit.assertEquals (OperationStatus.Success,junoResponse1.getStatus());
	...
	public void testCUpdateWithEmptyKey() throws JunoException, IOException {
		...
		try {
			junoClient.compareAndSet(rcx, data, (long)5);
	...
	public void testCUpdateKeyWhichDoesNotExist() throws JunoException, IOException {
		...
		try {
			JunoResponse mResponse = junoClient.compareAndSet(rcx, data, (long)5);
	...
	public void testCUpdateWith129BytesKey() throws JunoException, IOException{
		...
		try{
			...
			AssertJUnit.assertEquals(data.length, junoResponse.getValue().length);
			AssertJUnit.assertEquals(new String(data), new String(junoResponse.getValue()));
			junoClient.compareAndSet(junoResponse.getRecordContext(), data, (long)5);
	...
	public void testCUpdateWithSpecialCharsKey() throws JunoException, IOException{
		...
		// This TTL (2000) is < 2100 so the TTL will not be updated
		junoResponse = junoClient.compareAndSet(junoResponse.getRecordContext(), data, (long)2000);
		AssertJUnit.assertEquals (OperationStatus.Success,junoResponse.getStatus());
		...
		junoResponse = junoClient.get(key1, 2200);
		AssertJUnit.assertEquals (OperationStatus.Success,junoResponse.getStatus());
		AssertJUnit.assertTrue(2 == junoResponse.getVersion());
	...
	public void testCUpdateWithZeroNegLifetime() throws JunoException, IOException{
		...
		AssertJUnit.assertEquals(data.length, junoResponse.getValue().length);
		AssertJUnit.assertEquals(new String(data), new String(junoResponse.getValue()));
		JunoResponse junoResponse1 = junoClient.compareAndSet(junoResponse.getRecordContext(), data1, (long)0);
		AssertJUnit.assertEquals (OperationStatus.Success,junoResponse1.getStatus());
		AssertJUnit.assertTrue(2 == junoResponse1.getVersion());
		...
		try {
			junoResponse = junoClient.compareAndSet(junoResponse1.getRecordContext(), data1, (long)-1);
	...
	public void testCUpdateWith3DaysLifetime() throws JunoException, IOException{
		...
		AssertJUnit.assertEquals(data.length, junoResponse.getValue().length);
		AssertJUnit.assertEquals(new String(data), new String(junoResponse.getValue()));
		JunoResponse junoResponse1 = junoClient.compareAndSet(junoResponse.getRecordContext(), data1, lifetime);
		AssertJUnit.assertEquals (OperationStatus.Success,junoResponse1.getStatus());
		AssertJUnit.assertEquals(key, junoResponse1.key());
		AssertJUnit.assertTrue(2 == junoResponse1.getVersion());
	...
	public void testCUpdateWithMorethan3DaysLifetime() throws JunoException, IOException{
		...
		try{
			...
			JunoResponse junoResponse1 = junoClient.compareAndSet(junoResponse.getRecordContext(), data,lifetime);
	...
	/**
	 * Send a cas request with null payload and should generate an exception
	 * @throws JunoException
	 * @throws IOException
	 */
	@Test
	public void testCUpdateWithNullPayload() throws JunoException, IOException{
		...
		try{
			...
			AssertJUnit.assertEquals(new String(data), new String(junoResponse.getValue()));
			@SuppressWarnings("unused")
			JunoResponse junoResponse1 = junoClient.compareAndSet(junoResponse.getRecordContext(), null, (long)5);
			AssertJUnit.assertEquals (OperationStatus.Success,junoResponse1.getStatus());
			AssertJUnit.assertTrue(2 == junoResponse1.getVersion());
	...
	/**
	 * Send a cas request with 0 payload and should generate an exception
	 * @throws JunoException
	 * @throws IOException
	 */
	@Test
	...
	public void testCUpdateWith200KBPayload() throws JunoException, IOException{
		...
		try {
			...
			AssertJUnit.fail(mex.getMessage());
		}
	...
	public void testCUpdateWithLifeTimeAndPayload() throws JunoException, Exception{
		...
		JunoResponse junoResponse1 = junoClient.compareAndSet(junoResponse.getRecordContext(), data1, lifetime1);
		AssertJUnit.assertEquals (OperationStatus.Success,junoResponse1.getStatus());
		Thread.sleep(6000);
		AssertJUnit.assertEquals(key, junoResponse1.key());
		AssertJUnit.assertTrue(2 == junoResponse1.getVersion());
		...
		Thread.sleep (2000);
		//Sleep 2 more seconds for a total of 8 seconds
		try {
			JunoResponse mResponse = junoClient.compareAndSet(junoResponse.getRecordContext(), data1, lifetime2);
			AssertJUnit.assertEquals (OperationStatus.NoKey,mResponse.getStatus());
		} catch (JunoException mex) {
			AssertJUnit.assertTrue ("Exception is seen for key", false);
			LOGGER.info("SUCCESS");
	...
	public void testCUpdateWithSameNameSpaceDiffAppname() throws JunoException, IOException{
		...
		JunoResponse junoResponse1 = junoClient2.compareAndSet(junoResponse.getRecordContext(), data1, (long)5);
		AssertJUnit.assertEquals (OperationStatus.Success,junoResponse1.getStatus());
		AssertJUnit.assertEquals(key, junoResponse1.key());
		AssertJUnit.assertEquals(OperationStatus.Success, junoResponse1.getStatus());
		AssertJUnit.assertTrue(2 == junoResponse1.getVersion());
	...
	public void testCUpdateExpiredData() throws JunoException, IOException{
		...
		byte[] key = DataGenUtils.genBytes(64);
		try{
			JunoResponse junoResponse = junoClient.create(key, data, (long)5);
			AssertJUnit.assertEquals (OperationStatus.Success,junoResponse.getStatus());
			junoResponse = junoClient.get(key);
			AssertJUnit.assertEquals (OperationStatus.Success,junoResponse.getStatus());
			AssertJUnit.assertEquals(key, junoResponse.key());
			...
			Thread.sleep(6000);
			try {
				JunoResponse mResponse = junoClient.compareAndSet(junoResponse.getRecordContext(), data, (long)5);
				AssertJUnit.assertEquals (OperationStatus.NoKey,mResponse.getStatus());
			} catch (JunoException mex) {
				AssertJUnit.assertTrue ("Exception is seen for key", false);
				LOGGER.info("SUCCESS");
	...
	public void testCUpdateDifferentNamespace() throws JunoException, IOException{
		...
		try{
			JunoResponse junoResponse = junoClient.create(key, data, (long)5);
			AssertJUnit.assertEquals (OperationStatus.Success,junoResponse.getStatus());
			junoResponse = junoClient1.create(key1, data, (long)5);
			AssertJUnit.assertEquals (OperationStatus.Success,junoResponse.getStatus());
			junoResponse = junoClient.get(key);
			AssertJUnit.assertEquals (OperationStatus.Success,junoResponse.getStatus());
			AssertJUnit.assertEquals(key, junoResponse.key());
			...
			AssertJUnit.assertEquals(new String(data), new String(junoResponse.getValue()));
			try {
				JunoResponse mResponse = junoClient1.compareAndSet(junoResponse.getRecordContext(), data, (long)10);
				AssertJUnit.assertEquals (OperationStatus.NoKey, mResponse.getStatus());
			} catch (JunoException mex) {
				AssertJUnit.assertTrue ("Exception is seen for key", false);
				LOGGER.info("SUCCESS");
	...
	public void testCUpdateVersionTooOld() throws JunoException, IOException{
		...
		byte[] key = DataGenUtils.genBytes(64);
		try{
			JunoResponse junoResponse = junoClient.create(key, data, 10);
			AssertJUnit.assertEquals (OperationStatus.Success,junoResponse.getStatus());
			...
			JunoResponse junoResponse1 = junoClient.compareAndSet(junoResponse.getRecordContext(), data2.getBytes(), new Long (15));
			...
			try {
				JunoResponse mResponse1 = junoClient.compareAndSet(junoResponse.getRecordContext(), data3.getBytes(), new Long(1));
			...
			JunoResponse mResponse1 = junoClient.get(key);
	...
	public void testCUpdateVersionTooOld2() throws JunoException, IOException{
		...
		try{
			...
			JunoResponse junoResponse2 = junoClient.compareAndSet(junoResponse.getRecordContext(), data2.getBytes(), new Long (15));
			AssertJUnit.assertEquals (OperationStatus.Success,junoResponse2.getStatus());
			AssertJUnit.assertTrue (2 == junoResponse2.getVersion());
			...
			LOGGER.debug("Use cas()to update data");
			try {
				JunoResponse junoResponse3 = junoClient.compareAndSet(junoResponse.getRecordContext(), data3.getBytes(), new Long (15));
			...
			JunoResponse junoResponse4 = junoClient.get(key);
	...
	public void testCUpdateVersionOverflow() throws JunoException, IOException{
		...
		byte[] data = DataGenUtils.genBytes(10);
		byte[] data1 = DataGenUtils.genBytes(11);
		junoClient.create(key, data, (long)20);
		long lifetime = 5L;
		//after 65536, should be overflow
		for (int i = 0; i < 65540; i++) {
			lifetime +=1;
			JunoResponse junoResponse = junoClient.get(key, lifetime);
			AssertJUnit.assertEquals (OperationStatus.Success,junoResponse.getStatus());
			JunoResponse junoResponse1 = junoClient.compareAndSet(junoResponse.getRecordContext(), data1, (long)5);
			AssertJUnit.assertEquals (OperationStatus.Success,junoResponse1.getStatus());
