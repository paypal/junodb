...
public interface JunoReactClient {
    /**
     ...
     * @return Flux<JunoResponse> - List of responses for the requests
     * @throws JunoException - Throws Exception if any issue while processing the requests
     */
    public Flux<JunoResponse> doBatch(Iterable<JunoRequest> request) throws JunoException;
